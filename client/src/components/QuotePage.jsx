...
function CategoryIcon({ slug }) {
  ...
  switch (slug) {
    case 'all':
      return <svg {...p}><rect x="1" y="1" width="5.5" height="5.5" rx="1"/><rect x="8.5" y="1" width="5.5" height="5.5" rx="1"/><rect x="1" y="8.5" width="5.5" height="5.5" rx="1"/><rect x="8.5" y="8.5" width="5.5" height="5.5" rx="1"/></svg>;
    case 'materials':
      return <svg {...p}><rect x="1" y="2" width="5.5" height="3" rx="0.75"/><rect x="8.5" y="2" width="5.5" height="3" rx="0.75"/><rect x="4" y="6.5" width="7" height="3" rx="0.75"/><rect x="1" y="11" width="4.5" height="3" rx="0.75"/><rect x="9.5" y="11" width="4.5" height="3" rx="0.75"/></svg>;
    case 'labor':
      return <svg {...p}><circle cx="7.5" cy="4.5" r="2.5"/><path d="M1.5 14.5c0-3.314 2.686-6 6-6s6 2.686 6 6"/></svg>;
    case 'concrete':
      return <svg {...p}><rect x="1" y="5.5" width="5.5" height="3.5" rx="1"/><rect x="8.5" y="5.5" width="5.5" height="3.5" rx="1"/><rect x="4" y="1" width="7" height="3" rx="1"/><rect x="2" y="11" width="11" height="3" rx="1"/></svg>;
    case 'plumbing':
      return <svg {...p}><path d="M2 2h4v8a3 3 0 0 0 6 0V7h1"/><circle cx="13" cy="6" r="1.5"/></svg>;
    case 'electrical':
      return <svg {...p}><path d="M8.5 1.5L3 8.5h5L5.5 13.5 13 6.5H8L8.5 1.5z"/></svg>;
    case 'hvac':
      return <svg {...p}><circle cx="7.5" cy="7.5" r="5.5"/><path d="M7.5 2.5v10M2.5 7.5h10"/><path d="M4.6 4.6l5.8 5.8M10.4 4.6L4.6 10.4"/></svg>;
    case 'framing':
      return <svg {...p}><rect x="1" y="1" width="13" height="13" rx="1"/><rect x="4" y="4" width="7" height="7" rx="0.5"/></svg>;
    case 'roofing':
      return <svg {...p}><path d="M1 9.5L7.5 2.5 14 9.5"/><rect x="3" y="9.5" width="9" height="4" rx="1"/><path d="M6.5 9.5v4"/></svg>;
    case 'finishes':
      return <svg {...p}><path d="M2.5 12.5l2-2 7-7a1.5 1.5 0 0 0-2.1-2.1l-7 7-2 2.1z"/><path d="M10 3.5l1.5 1.5"/></svg>;
    case 'equipment':
      return <svg {...p}><rect x="0.5" y="7.5" width="10" height="5" rx="1"/><path d="M10.5 9.5l3-2-3-2"/><circle cx="3.5" cy="12.5" r="1.5"/><circle cx="7.5" cy="12.5" r="1.5"/></svg>;
    case 'permits':
      return <svg {...p}><rect x="2.5" y="0.5" width="10" height="14" rx="1"/><path d="M5.5 5h4"/><path d="M5.5 8h4"/><path d="M5.5 11h2"/></svg>;
    default:
      return <svg {...p}><rect x="1" y="1" width="13" height="13" rx="2"/></svg>;
  }
}
...
export default function QuotePage() {
  ...
  // < 1024px: sidebar becomes a horizontal pill bar, quote panel becomes a bottom sheet
  const isNarrow = windowWidth < 1024;

  // ── Quote panel content (shared between desktop sidebar and mobile sheet) ──
    ...
    <>
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <span style={{ fontWeight: 600, fontSize: '0.9rem', color: 'var(--text-primary)', letterSpacing: '-0.01em' }}>Your Quote</span>
          {quoteItems.length > 0 && (
            <span style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          {quoteItems.length > 0 && (
            <span style={{ fontWeight: 700, color: 'var(--rust)', fontSize: '0.92rem', letterSpacing: '-0.01em' }}>
              {fmt(quoteTotal)}
            </span>
          )}
          {isNarrow && (
      ...
      {isNarrow && (
        <div className="no-print" style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            {quoteItems.length > 0 ? (
              <div style={{ color: 'rgba(255,255,255,0.55)', fontSize: '0.78rem', marginTop: 1 }}>
                {fmt(quoteTotal)}
              </div>
            ) : (
              <div style={{ color: 'rgba(255,255,255,0.35)', fontSize: '0.78rem', marginTop: 1 }}>
                No items yet
              </div>
            )}
          </div>
          ...
          >
            {quoteItems.length > 0 ? 'View Quote' : 'Build Quote'}
          </button>
        </div>
      )}
